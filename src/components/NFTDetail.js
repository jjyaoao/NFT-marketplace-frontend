...
const NFTDetail = () => {
  ...
  const handleBuyClick = async () => {
    if (allowance === 0) {
      await approve("0xCf7Ed3AccA5a467e9e704C703E8D87F634fB0Fc9", "10000000000000000000000");
    } else {
      await buy(tokenId);
    }
  };
  ...
  useEffect(() => {
    const getInfo = async () => {
      ...
      const allowance = await getAllowance(address, "0xCf7Ed3AccA5a467e9e704C703E8D87F634fB0Fc9");
